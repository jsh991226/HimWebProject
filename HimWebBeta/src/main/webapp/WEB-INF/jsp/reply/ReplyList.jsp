...
<%
 /**
  * @Class Name : ReplyList.jsp
  * @Description : Reply List 화면
...
function fn_egov_select(id) {
	document.getElementById("listForm").id.value = id;
   	document.getElementById("listForm").action = "<c:url value='/reply/updateReplyView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/reply/addReplyView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/reply/ReplyList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
						...
						<td align="center" class="listtd"><c:out value="${result.owner}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.regdate}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.boardid}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.replygroup}"/>&nbsp;</td>
				    			</tr>
			</c:forEach>
		</table>
	</div>
